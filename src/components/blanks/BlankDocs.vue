<template>
    <section class="container">
        <div class="bg-white py-5 px-3 shadow mb-3">
            ...
            <button v-if="!mobileDetect" v-for="doc in docs" :class="elClass + ' w-100'" data-bs-toggle="modal" data-bs-target="#docs-modal" @click="editModal(doc.document)" v-html="doc.name"></button>
